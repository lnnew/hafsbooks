            ...
            <link rel="stylesheet" href="https://www.w3schools.com/w3css/4/w3.css">
             ...
             <a href="/auth/update" class="w3-button w3-card w3-round" style="background-color:#FCD0E9; font-size:11px;"><i class="fa fa-user w3-white" aria-hidden="true"></i>회원 정보 수정</a>
                  ...
                  <div class=" w3-right" style="width:110px;">
                    <a href="/auth/logout" class=" w3-button w3-card w3-round" style="background-color:#86DBD6; font-size:11px;"><i class="fa fa-user" style="color::white;"aria-hidden="true"></i><u>로그아웃하기 Logout</u></a>
                      </div>
                </div>
              ${pd}
        </div>
...
main: function(current_cat, intlcat_str,domecat_str,bothcat_str, book_str,admin) {
  ...
  <nav class="w3-sidebar w3-bar-block w3-white w3-collapse w3-top" style="z-index:3;width:270px" id="mySidebar">
    ...
    <a href="/auth/logout" class="w3-bar-item w3-button w3-padding w3-card w3-round" style="background-color:#86DBD6;"><i class="fa fa-user" style="color::white;"aria-hidden="true"></i><u>로그아웃하기 Logout</u></a>
    <a href="/auth/update" class="w3-bar-item w3-button w3-padding w3-card w3-round" style="background-color:#FCD0E9;"><i class="fa fa-user w3-white" aria-hidden="true"></i>회원 정보 수정 Edit Profile</a>
    <a href="javascript:void(0)" class="w3-bar-item w3-button w3-padding w3-card w3-round" style="background-color:#FEE4AB;" onclick="document.getElementById('newsletter').style.display='block'"><i class="fa fa-question-circle w3-white" aria-hidden="true"></i>북마켓이란? About HAFSBookstore</a>

    <div class="w3-padding-64 w3-large w3-text-grey" style="font-weight:bold">
      <a href="#" class="w3-bar-item  w3-button">카테고리</a>

      <a onclick="myAccFunc()" href="javascript:void(0)" class="w3-button w3-block w3-white w3-left-align" id="myBtn">
        국제 도서 Books for International Course Students <i class="fa fa-caret-down"></i>
      </a>
      ...
      <a onclick="myAccFunc2()" href="javascript:void(0)" class="w3-button w3-block w3-white w3-left-align" id="myBtn">
        국내 도서 Books for Domestic Course Students <i class="fa fa-caret-down"></i>
      </a>
...
${domecat_str}
      ...
      <a onclick="myAccFunc3()" href="javascript:void(0)" class="w3-button w3-block w3-white w3-left-align" id="myBtn">
        공용 및 기타 Other Books<i class="fa fa-caret-down"></i>
      </a>
  ...
  <div class="w3-main" style="margin-left:290px">
    ...
    <footer class="bb w3-padding-64 w3-light-grey w3-small w3-center" id="footer">
      <div class="w3-row-padding bb" style="text-align: center">
<p style="font-size: 5px;">사용 문의: <a href="https://www.facebook.com/hafs.enjoyguk/">국내학습부 페이스북 페이지 홈페이지 Student Council Facebook Page</a><br>
Developed by Jihyun Yoo, Hankuk Academy of Foreign Studies '21. </p>
      </div>
    </footer>
  ...
  <div id="newsletter" class="w3-modal">
    <div class="w3-modal-content w3-animate-zoom" style="padding:32px">
      <div class="w3-container w3-white w3-center">
        ...
        <h2 align:'center' >북마켓 About HAFSBookstore<i class="fa fa-question-circle" aria-hidden="true"></i></h2>
        <p>북마켓은 국내학습부&국제학습부가 주관하는 사업으로, 수익금은 전액 유네스코에 기부될 예정입니다. The total revenue from this contact-free bazaar is donated to UNESCO.</p>
        <button type="button" class="w3-button w3-padding-large w3-red w3-margin-bottom" onclick="document.getElementById('newsletter').style.display='none'">좋은 것 같아요! Sounds Great!<i class="far fa-grin-stars"></i></button>
      </div>
    </div>
  </div>
 <script type="text/javascript">
